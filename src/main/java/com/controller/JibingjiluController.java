...
public class JibingjiluController {
    ...
    public R page(@RequestParam Map<String, Object> params,JibingjiluEntity jibingjilu, 
		...
		if(tableName.equals("shisheng")) {
			jibingjilu.setShishengzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yisheng")) {
			jibingjilu.setYishengzhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<JibingjiluEntity> wrapper = new EntityWrapper<JibingjiluEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = jibingjiluService.selectCount(wrapper);
