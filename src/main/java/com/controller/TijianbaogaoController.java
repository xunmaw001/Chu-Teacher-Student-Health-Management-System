...
public class TijianbaogaoController {
    ...
    public R page(@RequestParam Map<String, Object> params,TijianbaogaoEntity tijianbaogao, 
		...
		if(tableName.equals("shisheng")) {
			tijianbaogao.setShishengzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yisheng")) {
			tijianbaogao.setYishengzhanghao((String)request.getSession().getAttribute("username"));
		}
