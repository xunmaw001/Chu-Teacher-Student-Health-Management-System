...
public class JianshenjiaolianController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JianshenjiaolianEntity user = jianshenjiaolianService.selectOne(new EntityWrapper<JianshenjiaolianEntity>().eq("jiaolianzhanghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(user.getId(), username,"jianshenjiaolian",  "健身教练" );
    ...
    public R register(@RequestBody JianshenjiaolianEntity jianshenjiaolian){
    	...
    	JianshenjiaolianEntity user = jianshenjiaolianService.selectOne(new EntityWrapper<JianshenjiaolianEntity>().eq("jiaolianzhanghao", jianshenjiaolian.getJiaolianzhanghao()));
		if(user!=null) {
