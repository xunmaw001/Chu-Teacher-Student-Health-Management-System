    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="教练建议" prop="jiaolianjianyi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="教练建议"
                  v-model="ruleForm.jiaolianjianyi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiaolianjianyi" label="教练建议" prop="jiaolianjianyi">
                    <span>{{ruleForm.jiaolianjianyi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueyuan = true;
          ...
          if(o=='jiaolianjianyi'){
            this.ruleForm.jiaolianjianyi = obj[o];
	    this.ro.jiaolianjianyi = true;
            continue;
          }
    ...
    info(id) {
      this.$http({
        url: `jianshenjiaolianjianyi/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jianshenjiaolianjianyi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jianshenjiaolianjianyiCrossAddOrUpdateFlag = false;
                  this.parent.search();
