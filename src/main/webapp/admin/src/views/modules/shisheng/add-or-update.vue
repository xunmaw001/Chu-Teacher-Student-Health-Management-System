<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="师生账号" prop="shishengzhanghao">
          <el-input v-model="ruleForm.shishengzhanghao" 
              placeholder="师生账号" clearable  :readonly="ro.shishengzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="师生账号" prop="shishengzhanghao">
              <el-input v-model="ruleForm.shishengzhanghao" 
...
export default {
  data() {
	...
	zhaopian : false,
      ...
      rules: {
          shishengzhanghao: [
                { required: true, message: '师生账号不能为空', trigger: 'blur' },
          ],
          mima: [
                { required: true, message: '密码不能为空', trigger: 'blur' },
          ],
          shishengxingming: [
                { required: true, message: '师生姓名不能为空', trigger: 'blur' },
          ],
          xingbie: [
          ],
          chushengriqi: [
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shisheng/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shishengCrossAddOrUpdateFlag = false;
                  this.parent.search();
