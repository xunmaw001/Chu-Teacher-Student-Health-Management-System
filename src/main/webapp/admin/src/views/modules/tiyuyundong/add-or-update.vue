    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="远动会记录" prop="yuandonghuijilu">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="远动会记录"
                  v-model="ruleForm.yuandonghuijilu" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yuandonghuijilu" label="远动会记录" prop="yuandonghuijilu">
                    <span>{{ruleForm.yuandonghuijilu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="体育课成绩" prop="tiyukechengji">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="体育课成绩"
                  v-model="ruleForm.tiyukechengji" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tiyukechengji" label="体育课成绩" prop="tiyukechengji">
                    <span>{{ruleForm.tiyukechengji}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="擅长运动" prop="shanzhangyundong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="擅长运动"
                  v-model="ruleForm.shanzhangyundong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shanzhangyundong" label="擅长运动" prop="shanzhangyundong">
                    <span>{{ruleForm.shanzhangyundong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="荣誉称号" prop="rongyuchenghao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="荣誉称号"
                  v-model="ruleForm.rongyuchenghao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.rongyuchenghao" label="荣誉称号" prop="rongyuchenghao">
                    <span>{{ruleForm.rongyuchenghao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	xueyuan : false,
	yuandonghuijilu : false,
	tiyukechengji : false,
	shanzhangyundong : false,
	rongyuchenghao : false,
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueyuan = true;
          ...
          if(o=='yuandonghuijilu'){
            this.ruleForm.yuandonghuijilu = obj[o];
	    this.ro.yuandonghuijilu = true;
            continue;
          }
          if(o=='tiyukechengji'){
            this.ruleForm.tiyukechengji = obj[o];
	    this.ro.tiyukechengji = true;
            continue;
          }
          if(o=='shanzhangyundong'){
            this.ruleForm.shanzhangyundong = obj[o];
	    this.ro.shanzhangyundong = true;
            continue;
          }
          if(o=='rongyuchenghao'){
            this.ruleForm.rongyuchenghao = obj[o];
	    this.ro.rongyuchenghao = true;
            continue;
          }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `tiyuyundong/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tiyuyundongCrossAddOrUpdateFlag = false;
                  this.parent.search();
