<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="家族病史" prop="jiazubingshi">
          <el-input v-model="ruleForm.jiazubingshi" 
              placeholder="家族病史" clearable  :readonly="ro.jiazubingshi"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="重大疾病" prop="zhongdajibing">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="重大疾病"
                  v-model="ruleForm.zhongdajibing" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhongdajibing" label="重大疾病" prop="zhongdajibing">
                    <span>{{ruleForm.zhongdajibing}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zhuyuanjilu" label="住院记录" prop="zhuyuanjilu">
                    <span>{{ruleForm.zhuyuanjilu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueyuan = true;
          ...
          if(o=='zhongdajibing'){
            this.ruleForm.zhongdajibing = obj[o];
	    this.ro.zhongdajibing = true;
            continue;
          }
          if(o=='zhuyuanjilu'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jibingjilu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jibingjiluCrossAddOrUpdateFlag = false;
                  this.parent.search();
